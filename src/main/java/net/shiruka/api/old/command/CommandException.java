...
import net.shiruka.api.old.command.exceptions.CeDynamic;
import net.shiruka.api.old.command.exceptions.CeDynamic2;
import net.shiruka.api.old.command.exceptions.CeSimple;
