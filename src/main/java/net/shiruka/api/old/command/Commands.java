...
import net.shiruka.api.old.command.arguments.BooleanArgumentType;
import net.shiruka.api.old.command.arguments.ByteArgumentType;
import net.shiruka.api.old.command.arguments.DoubleArgumentType;
import net.shiruka.api.old.command.arguments.FloatArgumentType;
import net.shiruka.api.old.command.arguments.IntegerArgumentType;
import net.shiruka.api.old.command.arguments.LongArgumentType;
import net.shiruka.api.old.command.arguments.ShortArgumentType;
import net.shiruka.api.old.command.arguments.StringArgumentType;
import net.shiruka.api.old.command.arguments.UniqueIdArgumentType;
import net.shiruka.api.old.command.builder.LiteralBuilder;
import net.shiruka.api.old.command.builder.RequiredBuilder;
