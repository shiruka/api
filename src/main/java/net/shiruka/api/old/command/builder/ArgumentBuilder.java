...
import net.shiruka.api.old.base.Self;
...
import net.shiruka.api.old.command.SingleRedirectModifier;
...
import net.shiruka.api.old.command.sender.RemoteConsoleCommandSender;
import net.shiruka.api.old.command.tree.RootNode;
